...
@interface GTPageController () <GTMenuViewDelegate,UIScrollViewDelegate> {
    CGFloat viewHeight;
    CGFloat viewWidth;
    CGFloat targetX;
    BOOL    animate;
...
@property (nonatomic, weak) GTMenuView *menuView;
...
@implementation GTPageController
...
- (void)setCachePolicy:(GTPageControllerCachePolicy)cachePolicy {
...
- (void)postAddToSuperViewNotificationWithIndex:(int)index {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:GTControllerDidAddToSuperViewNotification
                                                        object:info];
}
...
- (void)postFullyDisplayedNotificationWithCurrentIndex:(int)index {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:GTControllerDidFullyDisplayedNotification
                                                        object:info];
}
...
- (void)setup {
    // title
    self.titleSizeSelected = GTTitleSizeSelected;
    self.titleColorSelected = GTTitleColorSelected;
    self.titleSizeNormal = GTTitleSizeNormal;
    self.titleColorNormal = GTTitleColorNormal;
    // menu
    self.menuBGColor = GTMenuBGColor;
    self.menuHeight = GTMenuHeight;
    self.menuItemWidth = GTMenuItemWidth;
    // cache
...
- (void)addMenuView {
    ...
    GTMenuView *menuView = [[GTMenuView alloc] initWithFrame:frame buttonItems:self.titles backgroundColor:self.menuBGColor norSize:self.titleSizeNormal selSize:self.titleSizeSelected norColor:self.titleColorNormal selColor:self.titleColorSelected];
...
- (void)didReceiveMemoryWarning {
    ...
    self.cachePolicy = GTPageControllerCachePolicyLoGTemory;
    // 取消正在增长的 cache 操作
...
#pragma mark - GTMenuView Delegate
